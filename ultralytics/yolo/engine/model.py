...
class YOLO:
    ...
    def __init__(self, model: Union[str, Path] = 'yolov8n.pt', task=None, half=False) -> None:
        """
        ...
        if suffix == '.yaml':
            ...
            self._load(model, task, half=self.half)
    ...
    def _load(self, weights: str, task=None, half=False):
        """
        Initializes a new model and infers the task type from the model head.
